...
document.querySelectorAll(".cmplz-consent-area.cmplz-placeholder").forEach(e=>{
    e.addEventListener("click", e=>{
        let t = e.target;
        (t = t.classList.contains("cmplz-consent-area") ? t : e.target.closest(".cmplz-consent-area.cmplz-placeholder")) && (cmplz_set_service_consent(e = t.getAttribute("data-service"), !0),
...
document.addEventListener("cmplz_manage_consent_container_loaded", function(e) {
    ...
    -1 != c.indexOf("#") && (t = -1 != c.lastIndexOf("?") ? c.lastIndexOf("?") : void 0,
    c = c.substring(c.indexOf("#") + 1, t),
    t = document.getElementById(c)) && (c = t.getBoundingClientRect().top + window.pageYOffset - 200,
    window.scrollTo({
        top: c,
        behavior: "smooth"
    }))
...
function() {
    function e(e, t) {
        ...
        return c.initCustomEvent(e, t.bubbles, t.cancelable, t.detail),
        c
    }
    "function" != typeof window.CustomEvent && (e.prototype = window.Event.prototype,
    window.CustomEvent = e)
}();
let cmplz_banner, cmplz_banner_container = document.getElementById("cmplz-cookiebanner-container"), cmplz_manage_consent_button, cmplz_waiting_inline_scripts = [], cmplz_waiting_scripts = [], cmplz_fired_scripts = [], cmplz_placeholder_class_index = 0, cmplz_all_scripts_hook_fired = !1, cmplz_consent_stored_once = !1, cmplz_fired_category_events = ["functional"], cmplz_fired_service_events = [], cmplz_categories = ["functional", "preferences", "statistics", "marketing"];
function cmplz_set_category_as_body_class() {
    var t = document.body.className.split(/\s+/);
    for (let e = 0; e < t.length; e++)
        -1 !== t[e].indexOf("cmplz-") && "cmplz-document" !== t[e] && document.body.classList.remove(t[e]);
    var e, c = cmplz_accepted_categories();
    for (e in c)
        c.hasOwnProperty(e) && document.body.classList.add("cmplz-" + c[e]);
    var n, o = cmplz_get_all_service_consents();
    for (n in o)
        o.hasOwnProperty(n) && o[n] && document.body.classList.add("cmplz-" + n);
...
function cmplz_run_script(t, c, n, e, o) {
    ...
    if ("inline" !== e ? a.setAttribute("src", t) : ("string" != typeof t && (t = t.innerHTML),
    ...
    !cmplz_in_array(t, cmplz_fired_scripts)) {
        ...
        try {
            ...
            throw cmplz_run_after_all_scripts(c, n),
...
function cmplz_maybe_run_waiting_scripts(e, t, c, n) {
    var o = cmplz_get_waiting_script(cmplz_waiting_scripts, e)
      , o = (o && cmplz_run_script(o, t, c, "src", n),
...
window.cmplz_set_cookie = function(n, o, a) {
    if ("undefined" != typeof document) {
        ...
        let e = ";secure";
        var i = new Date
          , i = (i.setTime(i.getTime() + 24 * complianz.cookie_expiry * 60 * 60 * 1e3),
        ";expires=" + i.toGMTString());
        "https:" !== window.location.protocol && (e = "");
        let t = cmplz_get_cookie_domain()
          , c = (0 < t.length && (t = ";domain=" + t),
        "");
        a && (c = complianz.prefix),
        document.cookie = c + n + "=" + o + ";SameSite=Lax" + e + i + t + ";path=" + cmplz_get_cookie_path()
    }
}
,
...
const cmplzLazyLoader = ()=>{
    ...
    const t = new IntersectionObserver((e,n)=>{
        e.forEach(e=>{
            var t, c;
            e.isIntersecting && (t = (e = e.target).getAttribute("data-placeholder-image"),
...
function cmplz_set_blocked_content_container() {
    document.querySelectorAll(".cmplz-image").forEach(e=>{
        var t, c, n, o;
        e.classList.contains("cmplz-processed") || (e.classList.add("cmplz-processed"),
        ...
        "lazy" === e.getAttribute("loading") && (e.removeAttribute("loading"),
        e.setAttribute("data-deferlazy", 1)),
        null == o && (cmplz_placeholder_class_index++,
    ...
    document.querySelectorAll(".cmplz-placeholder-element").forEach(t=>{
        if (!t.classList.contains("cmplz-processed")) {
            ...
            let e;
            null == (e = t.classList.contains("cmplz-iframe") ? ("lazy" === t.getAttribute("loading") && (t.removeAttribute("loading"),
            t.setAttribute("data-deferlazy", 1)),
            t.parentElement) : t).getAttribute("data-placeholder_class_index") && (cmplz_placeholder_class_index++,
            ...
            n = t.getAttribute("data-placeholder-image")) && void 0 !== n && n.length && e.setAttribute("data-placeholder-image", n)
        }
    }
    ),
    cmplzLazyLoader(),
        ...
        if (void 0 !== t) {
            if (1 == complianz.clean_cookies) {
                ...
                var a = c.querySelector("button")
                  , a = (a.setAttribute("data-service", o),
                a.setAttribute("data-category", n),
                a.setAttribute("aria-label", complianz.aria_label.replace("{service}", e)),
                complianz.page_links[complianz.region])
                  , i = c.querySelector(".cmplz-links a");
                a && a.hasOwnProperty("cookie-statement") && (i.setAttribute("href", a["cookie-statement"].url),
                "{title}" === i.innerText) && (i.innerText = a["cookie-statement"].title)
            } else {
...
function cmplz_set_blocked_content_container_aspect_ratio(o, a, i) {
    ...
    null != o && ((e = new Image).addEventListener("load", function() {
        ...
        o.clientWidth)
          , t = t * (c / e);
        let n = "";
        -1 === a.indexOf("placeholder.jpg") && (n = "height:" + t + "px;"),
        cmplz_append_css(".cmplz-placeholder-" + i + " {" + n + "}")
    }),
    e.src = a)
}
...
function cmplz_enable_category(o, a) {
    if (1 == complianz.tm_categories && "" !== o && cmplz_run_tm_event(o),
    a = void 0 !== a ? a : "do_not_match",
    "functional" !== (o = "" === o ? "do_not_match" : o)) {
        "marketing" === o && cmplz_set_integrations_cookies();
        let e;
        e = "do_not_match" !== a ? '.cmplz-blocked-content-notice [data-service="' + a + '"]' : 1 != complianz.clean_cookies ? ".cmplz-blocked-content-notice.cmplz-accept-" + o : '.cmplz-blocked-content-notice [data-category="' + o + '"]',
        document.querySelectorAll(e).forEach(e=>{
            var t = e.getAttribute("data-service");
            e.parentNode.classList.contains("cmplz-blocked-content-notice") && (e = e.parentNode),
        ...
        document.querySelectorAll('[data-category="' + o + '"], [data-service="' + a + '"]').forEach(t=>{
            ...
            if (!cmplz_is_service_denied(e) && "functional" !== t.getAttribute("data-category") && !t.classList.contains("cmplz-activated")) {
                ...
                if ("LINK" === e)
                    ...
                    cmplz_load_css(t.getAttribute("data-href"), o);
                else if ("IMG" === e) {
                    t.classList.add("cmplz-activated");
                    ...
                    t.classList.contains("cmplz-placeholder-element") && (t.classList.add("cmplz-activated"),
                    e = t.getAttribute("data-placeholder_class_index"),
                    t.classList.remove("cmplz-blocked-content-container"),
                    t.classList.remove("cmplz-placeholder-" + e))
            }
        }
        );
        ...
        t.forEach(e=>{
            ...
            t && (c ? cmplz_waiting_scripts[t] = c : 0 < e.innerText.length && (cmplz_waiting_inline_scripts[t] = e)),
            e.parentElement && e.parentElement.removeChild(e)
        }
        ),
        t.forEach(e=>{
            var t, c, n = e.getAttribute("type");
            !e.classList.contains("cmplz-activated") && n && "text/javascript" !== n && (e.classList.add("cmplz-activated"),
            (n = e.getAttribute("data-cmplz-src")) ? (e.removeAttribute("type"),
            cmplz_is_waiting_script(cmplz_waiting_scripts, n) || (e.getAttribute("data-post_scribe_id") ? (t = "#" + e.getAttribute("data-post_scribe_id"),
            (c = document.querySelector(t)) && (c.innerHtml(""),
            postscribe(t, "<script src=" + n + "><\/script>"))) : cmplz_run_script(n, o, a, "src", e))) : 0 < e.innerText.length && (cmplz_is_waiting_script(cmplz_waiting_inline_scripts, e.innerText) || cmplz_run_script(e.innerText, o, a, "inline", e)))
        }
        ),
...
function cmplz_remove_placeholder(e) {
    ...
    c && (t = c.getAttribute("data-placeholder_class_index"),
    c.classList.remove("cmplz-blocked-content-container"),
    c.classList.remove("cmplz-placeholder-" + t)),
...
function cmplz_is_waiting_script(t, c) {
    for (var n in t)
        if (t.hasOwnProperty(n)) {
            let e = t[n];
            if ("string" != typeof e && (e = e.innerText),
...
function cmplz_run_after_all_scripts(e, t) {
    ...
    (n || c) && (n && cmplz_fired_category_events.push(e),
    ...
    c = new CustomEvent("cmplz_enable_category",{
        detail: n
    }),
    document.dispatchEvent(c)),
    !cmplz_all_scripts_hook_fired && cmplz_array_is_empty(cmplz_waiting_inline_scripts) && cmplz_array_is_empty(cmplz_waiting_scripts) && (n = new CustomEvent("cmplz_run_after_all_scripts",{
        detail: e,
        service: t
    }),
...
1 == complianz.block_ajax_content && setInterval(function() {
    cmplz_set_blocked_content_container()
}, 2e3);
let cmplz_fired_events = [];
function cmplz_run_tm_event(e) {
    -1 === cmplz_fired_events.indexOf(e) && (cmplz_fired_events.push(e),
    window.dataLayer = window.dataLayer || [],
    -1 !== complianz.prefix.indexOf("rt_") && (window.dataLayer.push({
...
function cmplz_legacy() {
    ...
    document.querySelectorAll("[data-service=recaptcha]").forEach(e=>{
        e.setAttribute("data-service", "google-recaptcha"),
        t = !0
    }
    ),
    t && (console.log("recaptcha as service name is deprecated. Please rename the service in your custom html to google-recaptcha"),
...
function cmplz_set_service_consent(e, t) {
    ...
    n[e] = t,
    cmplz_set_cookie("consented_services", JSON.stringify(n));
    var c = {}
      , n = (c.service = e,
    c.value = t,
    c.region = complianz.region,
    cmplz_all_scripts_hook_fired = !1,
    new CustomEvent("cmplz_status_change_service",{
        detail: c
    }));
    document.dispatchEvent(n)
}
...
function cmplz_reload_browser_compatible() {
    var e;
    -1 < navigator.userAgent.toLowerCase().indexOf("firefox") ? ((e = new URL(window.location.href)).searchParams.set("cmplz-force-reload", Date.now().toString()),
    window.location.href = e.toString()) : window.location.reload()
}
window.cmplz_accept_all = function() {
    for (var e in cmplz_clear_all_service_consents(),
    cmplz_categories)
        cmplz_categories.hasOwnProperty(e) && cmplz_set_consent(cmplz_categories[e], "allow");
...
window.conditionally_show_banner = function() {
    ...
    var e, t, c = new CustomEvent("wp_consent_type_defined"), n = (document.dispatchEvent(c),
    ...
    for (e in n)
        n.hasOwnProperty(e) && (t = cmplz_categories[e],
        cmplz_has_consent(t)) && cmplz_enable_category(t);
    if (cmplz_exists_service_consent()) {
        cmplz_enable_category("", "general");
        var o, a, i, l = cmplz_get_services_on_page();
        for (o in l)
            l.hasOwnProperty(o) && (a = l[o].service,
            i = l[o].category,
            cmplz_has_service_consent(a, i)) && (document.querySelectorAll(".cmplz-accept-service[data-service=" + a + "]").forEach(e=>{
                e.checked = !0
            }
            ),
    ...
    c = new CustomEvent("cmplz_cookie_banner_data",{
        detail: complianz
    }),
    document.dispatchEvent(c),
    ...
    cmplz_do_not_track() ? (console.log("global privacy control or do not track detected: no banner."),
    cmplz_track_status("do_not_track")) : ("optin" === complianz.consenttype ? (complianz.forceEnableStats && cmplz_enable_category("statistics"),
    console.log("opt-in"),
    show_cookie_banner) : "optout" === complianz.consenttype ? (console.log("opt-out"),
    show_cookie_banner) : (console.log("other consent type, no cookie warning"),
    cmplz_accept_all))()
}
,
window.show_cookie_banner = function() {
    ...
    n.rel = "stylesheet",
    n.onload = function() {
        e || (cmplz_banner.classList.remove("cmplz-hidden"),
        cmplz_manage_consent_button.classList.remove("cmplz-hidden"))
    }
    ,
    document.getElementsByTagName("head")[0].appendChild(n),
    cmplz_banner && !e && (cmplz_banner.querySelectorAll(".cmplz-links a:not(.cmplz-external), .cmplz-buttons a:not(.cmplz-external)").forEach(e=>{
        var t, c = e;
        for (t in c.classList.add("cmplz-hidden"),
        o)
            o.hasOwnProperty(t) && c.classList.contains(t) && (c.setAttribute("href", o[t].url + c.getAttribute("data-relative_url")),
            "{title}" === c.innerText && (c.innerText = cmplz_html_decode(o[t].title)),
            c.classList.remove("cmplz-hidden"))
    }
    ),
    cmplz_set_banner_status(),
    t) && (cmplz_banner.classList.remove("cmplz-show"),
    cmplz_banner.classList.add("cmplz-dismissed"),
    cmplz_manage_consent_button.classList.remove("cmplz-dismissed"),
    cmplz_manage_consent_button.classList.add("cmplz-show")),
    c = new CustomEvent("cmplz_cookie_warning_loaded",{
...
window.cmplz_set_banner_status = function(e) {
    ...
    cmplz_banner && 0 < e.length && (cmplz_banner.classList.remove("cmplz-" + t),
    cmplz_banner.classList.add("cmplz-" + e),
    cmplz_manage_consent_button) && (cmplz_manage_consent_button.classList.add("cmplz-" + t),
    cmplz_manage_consent_button.classList.remove("cmplz-" + e)),
    cmplz_banner_container && complianz.soft_cookiewall && (cmplz_banner_container.classList.remove("cmplz-" + t),
    cmplz_banner_container.classList.add("cmplz-" + e),
...
window.cmplz_has_consent = function(e) {
    ...
    if ("functional" === e)
        return !0;
    let t, c;
    return t = cmplz_do_not_track() ? (c = cmplz_get_cookie(e),
    "allow" === c) : (c = cmplz_get_cookie(e),
    ("optout" === complianz.consenttype || "other" === complianz.consenttype) && "" === c || "allow" === c)
}
,
...
window.cmplz_set_consent = function(e, t) {
    ...
    cmplz_all_scripts_hook_fired = !1,
    c = new CustomEvent("cmplz_status_change",{
        detail: c
    }),
    document.dispatchEvent(c),
    "marketing" === e) && "deny" === t && "allow" === n && (cmplz_integrations_revoke(),
    setTimeout(function() {
...
if ("undefined" != typeof Storage && sessionStorage.cmplz_user_data && (cmplz_user_data = JSON.parse(sessionStorage.cmplz_user_data)),
...
function cmplz_set_up_auto_dismiss() {
    ...
    "optout" === complianz.consenttype && (1 == complianz.dismiss_on_scroll && (t = function(e) {
        window.pageYOffset > Math.floor(400) && (cmplz_set_banner_status("dismissed"),
        cmplz_fire_categories_event(),
        cmplz_track_status(),
    ...
    0 < (e = parseInt(complianz.dismiss_timeout))) && window.setTimeout(function() {
        cmplz_set_banner_status("dismissed"),
        cmplz_fire_categories_event(),
        cmplz_track_status()
    }, Math.floor(e))
...
function cmplz_fire_categories_event() {
    var e = new Object
      , e = (e.category = cmplz_highest_accepted_category(),
...
function cmplz_track_status(e) {
    var t, c = [], n = (e = void 0 !== e && e,
    new CustomEvent("cmplz_track_status",{
        detail: e
    }));
    document.dispatchEvent(n),
    c = e ? [e] : cmplz_accepted_categories(),
    cmplz_set_category_as_body_class();
    try {
    ...
    cmplz_equals(o, c) && cmplz_equals(t, n) || 1 != complianz.store_consent || cmplz_is_bot() || cmplz_is_speedbot() || (cmplz_set_cookie("saved_categories", JSON.stringify(c)),
...
function cmplz_accepted_categories() {
    var e, t, c = cmplz_categories, n = [];
    for (e in c)
        c.hasOwnProperty(e) && (t = c[e],
        cmplz_has_consent(t)) && n.push(t);
...
function cmplz_sync_category_checkboxes() {
    for (var e in cmplz_categories)
        cmplz_categories.hasOwnProperty(e) && (e = cmplz_categories[e],
        cmplz_has_consent(e) || "functional" === e ? document.querySelectorAll("input.cmplz-" + e).forEach(e=>{
            e.checked = !0
        }
        ) : document.querySelectorAll("input.cmplz-" + e).forEach(e=>{
            e.checked = !1
        ...
        document.querySelectorAll(".cmplz-accept-service").forEach(e=>{
            var t = e.getAttribute("data-service")
              , c = e.getAttribute("data-category");
            cmplz_has_service_consent(t, c) ? e.checked = !0 : cmplz_is_service_denied(t) ? e.checked = !1 : (c = e.getAttribute("data-category"),
...
function cmplz_merge_object(e, t) {
    var c, n = [];
    for (c in t)
        t.hasOwnProperty(c) && (n[c] = t[c]);
    for (c in e)
        t.hasOwnProperty(c) && void 0 !== t[c] || e.hasOwnProperty(c) && (n[c] = e[c]);
    return n
}
...
function cmplz_clear_cookies(e) {
    var t = !1;
    if ("undefined" != typeof document) {
        for (var c = ";secure", n = new Date, o = (n.setTime(n.getTime() - 864e5),
        ";expires=" + n.toGMTString()), a = ("https:" !== window.location.protocol && (c = ""),
        document.cookie.split("; ")), i = location.pathname.replace(/^\/|\/$/g, "").split("/"), l = 0; l < a.length; l++) {
            ...
            if (-1 !== r.indexOf(e)) {
                ...
                for (document.cookie = _ + "/"; 0 < i.length; )
                    0 < (m = i.join("/")).length && (document.cookie = _ + "/" + m,
                    document.cookie = _ + "/" + m + "/"),
                    i.pop();
                for (; 0 < s.length; ) {
                    var m, d = encodeURIComponent(r) + "=;SameSite=Lax" + c + o + ";domain=." + s.join(".") + ";path=";
                    for (document.cookie = d + "/"; 0 < i.length; )
                        0 < (m = i.join("/")).length && (document.cookie = d + "/" + m,
                        document.cookie = d + "/" + m + "/"),
                        i.pop();
                    s.shift(),
                    p && 1 == s.length && s.shift()
                }
            }
        }
        cmplz_set_accepted_cookie_policy_id()
...
function cmplz_integrations_revoke() {
    var e, t = complianz.set_cookies;
    for (e in t)
        t.hasOwnProperty(e) && (cmplz_set_cookie(e, t[e][1], !1),
        0 == t[e][1]) && cmplz_clear_cookies(e)
}
function cmplz_set_integrations_cookies() {
    var e, t = complianz.set_cookies;
    for (e in t)
        t.hasOwnProperty(e) && cmplz_set_cookie(e, t[e][0], !1)
}
    ...
    if (e && void 0 !== e && -1 != e.indexOf("?")) {
        ...
        if (1 != e.length)
            for (var c, n = e[1].split("&"), o = 0; o < n.length; o++)
                if (n.hasOwnProperty(o) && (c = n[o].split("="))[0] === t)
                    return void 0 === c[1] || decodeURIComponent(c[1])
    }
    return !1
}
...
1 == complianz.store_consent && (cmplz_id_cookie = cmplz_get_cookie("id"),
cmplz_id = cmplz_id_session = "",
"undefined" != typeof Storage && sessionStorage.cmplz_id && (cmplz_id_session = JSON.parse(sessionStorage.cmplz_id)),
0 == cmplz_id_cookie.length && 0 < cmplz_id_session.length && (cmplz_id = cmplz_id_session,
cmplz_set_cookie("id", cmplz_id)),
0 < cmplz_id_cookie.length && 0 == cmplz_id_session.length && (cmplz_id = cmplz_id_cookie),
"undefined" != typeof Storage) && (sessionStorage.cmplz_id = JSON.stringify(cmplz_id)),
...
window.cmplz_deny_all = function() {
    for (var e in cmplz_categories)
        cmplz_categories.hasOwnProperty(e) && cmplz_set_consent(cmplz_categories[e], "deny");
    var t = !1
      , c = ("functional" === cmplz_highest_accepted_category() && !cmplz_exists_service_consent() || (t = !0),
    cmplz_clear_cookies("cmplz_service") && (t = !0),
    cmplz_clear_all_service_consents(),
    cmplz_integrations_revoke(),
    cmplz_fire_categories_event(),
    cmplz_track_status(),
    new CustomEvent("cmplz_revoke",{
        detail: t
    }));
    document.dispatchEvent(c),
...
cmplz_add_event("click", ".cmplz-accept-service", function(e) {
    var e = e.target;
    "INPUT" !== e.tagName && (void 0 !== (e = e.getAttribute("data-service")) && (cmplz_set_service_consent(e, !0),
    cmplz_enable_category("", "general"),
...
cmplz_add_event("change", ".cmplz-accept-service", function(e) {
    var t = e.target
      , c = t.tagName
      , n = t.getAttribute("data-service");
    void 0 !== n && ("INPUT" === c ? (cmplz_set_banner_status("dismissed"),
    t.checked ? (cmplz_set_service_consent(n, !0),
    cmplz_enable_category("", n)) : (cmplz_set_service_consent(n, !1),
    setTimeout(function() {
        cmplz_reload_browser_compatible()
...
cmplz_add_event("click", ".cmplz-save-preferences", function(e) {
    ...
    for (t in cmplz_banner = e.closest(".cmplz-cookiebanner"),
    cmplz_categories)
        cmplz_categories.hasOwnProperty(t) && (c = cmplz_categories[t],
        n = cmplz_banner.querySelector("input.cmplz-" + c)) && (n.checked ? cmplz_set_consent(c, "allow") : cmplz_set_consent(c, "deny"));
    cmplz_set_banner_status("dismissed"),
    cmplz_fire_categories_event(),
    cmplz_track_status()
}),
...
cmplz_add_event("click", ".cmplz-view-preferences", function(e) {
    e = e.target;
    (cmplz_banner = e.closest(".cmplz-cookiebanner")).querySelector(".cmplz-categories").classList.contains("cmplz-fade-in") ? (cmplz_banner.classList.remove("cmplz-categories-visible"),
    cmplz_banner.querySelector(".cmplz-categories").classList.remove("cmplz-fade-in"),
    cmplz_banner.querySelector(".cmplz-view-preferences").style.display = "block",
    cmplz_banner.querySelector(".cmplz-save-preferences").style.display = "none") : (cmplz_banner.classList.add("cmplz-categories-visible"),
...
cmplz_add_event("change", ".cmplz-manage-consent-container .cmplz-category", function(e) {
    for (var t in cmplz_categories) {
        var c;
        cmplz_categories.hasOwnProperty(t) && (t = cmplz_categories[t],
        c = document.querySelector(".cmplz-manage-consent-container input.cmplz-" + t)) && (c.checked ? cmplz_set_consent(t, "allow") : cmplz_set_consent(t, "deny"),
        cmplz_set_banner_status("dismissed"),
        cmplz_fire_categories_event(),
        cmplz_track_status())
    }
...
cmplz_add_event("click", "button.cmplz-manage-settings", function(e) {
    ...
    cmplz_is_hidden(e) ? (t.style.display = "block",
...
function cmplz_start_clean() {
    if (1 == complianz.clean_cookies)
        if ((cmplz_cookie_data = "undefined" != typeof Storage ? JSON.parse(sessionStorage.getItem("cmplz_cookie_data")) : cmplz_cookie_data) && 0 != cmplz_cookie_data.length)
        ...
        if (!cmplz_has_consent(c) && cmplz_cookie_data.hasOwnProperty(c)) {
            ...
            for (n in o)
                if (!cmplz_has_service_consent(n, c)) {
                    ...
                    for (a in i) {
                        var l = i[a];
                        cmplz_clear_cookies(l),
                        cmplz_clear_storage(l)
                    }
                }
        }
    }
...
function cmplz_setup_clean_interval() {
    !cmplz_cookie_data || cmplzCleanCookieInterval || (cmplz_do_cleanup(),
    cmplzCleanCookieInterval = setInterval(cmplz_do_cleanup, 1e3))
}
function cmplz_clear_storage(e) {
    "undefined" != typeof Storage && (localStorage.getItem(e) && localStorage.removeItem(e),
...
function cmplz_load_manage_consent_container() {
    ...
    if (c) {
        ...
        t.open("GET", complianz.url + "manage_consent_html?" + complianz.locale, !0),
        ...
        t.onload = function() {
            ...
            cmplz_sync_category_checkboxes();
            document.querySelector("#cmplz-manage-consent-container-nojavascript").style.display = "none",
            c.style.display = "block";
...
function cmplz_equals(e, t) {
    if (Array.isArray(e) || (e = Object.keys(e),
    t = Object.keys(t)),
    !e || !t)
        return !1;
...
function cmplzCopyAttributes(e, t) {
    return Array.from(e.attributes).forEach(e=>{
        "data-script-type" === e.nodeName && "module" === e.nodeValue && (t.setAttribute("type", "module"),
...
void 0 !== window.jQuery && jQuery(document).ready(function(r) {
    ...
    function t() {
        if (document.querySelector(".cmplz-wp-video-shortcode")) {
            var e, t, n, o = cmplz_accepted_categories(), a = cmplz_get_all_service_consents(), i = [];
            for (e in o)
            ...
            for (t in a)
                a.hasOwnProperty(t) && i.push(".cmplz-wp-video-shortcode[data-service=" + t + "]");
            n = i.join(",");
            let c = !1;
    ...
    e = setInterval(function() {
        ...
        document.querySelector(".cmplz-wp-video-shortcode") && cmplz_times_checked < 100 ? t() : clearInterval(e)
    }, 500)),
